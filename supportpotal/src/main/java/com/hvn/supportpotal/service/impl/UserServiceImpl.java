...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    @Override
    public User register(UserDto userDto) throws EmailExistException, UsernameExistException {
        validateUser(StringUtils.EMPTY, userDto.getUsername(), userDto.getEmail());
        ...
        User user = User.builder()
                ...
                .profileImageUrl(getTempFileImageUrl())
                .build();
        userRepository.save(user);
    ...
    private User validateUser(String currentUsername, String newUsername, String newEmail) throws UsernameExistException, EmailExistException {
