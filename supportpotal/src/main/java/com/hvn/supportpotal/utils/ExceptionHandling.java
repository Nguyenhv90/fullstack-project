package com.hvn.supportpotal.utils;
...
import com.hvn.supportpotal.configuration.exception.UserNotFoundException;
...
//        return createHttpResponse(BAD_REQUEST, "Opp :((, Đây không phải lỗi của bạn, là lỗi của chúng tôi.");
//    }
    ...
    public ResponseEntity<HttpResponse> notFound404(IOException exception) {
        return createHttpResponse(NOT_FOUND, "Opp :((, Đây không phải lỗi của bạn, là lỗi của chúng tôi.");
    }
